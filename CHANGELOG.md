...
- **2차 View 설계 문서**: `working-diary notion views ensure`와 Core Views 5개, `Work Period` 기반 schema v5 방향, `작업 그룹별` follow-up, 운영/지능화 view 분리 기준, 하위 항목 데이터 구조, sub-item UI best-effort/fallback, partial failure/exit code 정책 정리
