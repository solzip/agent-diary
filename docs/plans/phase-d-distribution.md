...
```json
{
  ...
  "repository": "https://github.com/solzip/agent-diary",
  "license": "MIT",
...
- [ ] Badges 추가 (README):
  ...
  - ![CI](https://github.com/solzip/agent-diary/actions/workflows/ci.yml/badge.svg)
  - ![License](https://img.shields.io/github/license/solzip/agent-diary)
